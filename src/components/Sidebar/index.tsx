...
import SidebarColapsedItem from "./SidebarColapsed";
          ...
          <svg
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M12 2C13.6569 2 15 3.34315 15 5C15 6.65685 13.6569 8 12 8C10.3431 8 9 6.65685 9 5C9 3.34315 10.3431 2 12 2ZM12 9.5C10.0147 9.5 8.5 11.0147 8.5 13C8.5 14.9853 10.0147 16.5 12 16.5C13.9853 16.5 15.5 14.9853 15.5 13C15.5 11.0147 13.9853 9.5 12 9.5ZM7 13C7 11.067 8.567 9.5 10.5 9.5C11.3284 9.5 12.0845 9.81592 12.6374 10.3771C13.1903 9.81592 13.9464 9.5 14.775 9.5C16.708 9.5 18.275 11.067 18.275 13C18.275 13.7676 18.0143 14.4597 17.5691 15C17.1694 15.4883 16.6265 15.8128 16 15.9375V17H8V15.9375C7.37346 15.8128 6.83064 15.4883 6.43091 15C5.98566 14.4597 5.725 13.7676 5.725 13C5.725 11.067 7.292 9.5 9.225 9.5C9.64066 9.5 10.0339 9.60703 10.3874 9.79266C10.2405 10.1182 10.1348 10.4748 10.0875 10.85C9.75887 10.6977 9.39497 10.6052 9 10.6052C7.69297 10.6052 6.6052 11.6929 6.6052 13C6.6052 14.307 7.69297 15.3948 9 15.3948C9.8736 15.3948 10.6113 14.7177 10.823 13.8574C10.9628 13.9445 11.1191 14.0156 11.2854 14.0668C10.9622 15.1702 9.86473 16 8.5 16C6.567 16 5 14.433 5 12.5C5 10.567 6.567 9 8.5 9C9.69214 9 10.7731 9.59665 11.3874 10.55C11.6345 10.2164 11.9252 9.92057 12.25 9.6875C12.0736 9.49569 11.8339 9.33333 11.5 9.22368C11.2555 9.13457 11.0055 9.07468 10.75 9.04363C11.75 8.52345 13 8 12 8C10.75 8 9.75 8.5 9.75 8.5C8.9825 8.79437 8.5 9.5 8.5 10.5C8.5 11.5 8.9825 12.5 9.75 12.5C10.75 12.5 11.75 12 12 12C12.75 12 13.75 12.5 13.75 12.5C14.5175 12.5 15 11.5 15 10.5C15 9.5 14.5175 8.5 13.75 8.5C13.25 8.5 12.5 8 11.5 8.22368C10.5 8.5 9.75 9 9.75 9C9 9 8.5 8.5 8.5 8.5C7.75 8 7 9 7 9.5C7 10 7.5 10.5 8.5 10.5C9.5 10.5 9.75 11 9.75 11C9 11 8.5 12 8.5 12.5C8.5 13 9 13.5 9.75 13.5C10 13.5 10.25 13 10.5 12.75C11 12 12 12 12 12Z"
                fill=""
              />
            </svg>
          ...
          <svg
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M4 3C3.44772 3 3 3.44772 3 4V20C3 20.5523 3.44772 21 4 21H20C20.5523 21 21 20.5523 21 20V4C21 3.44772 20.5523 3 20 3H4ZM8 5H16V8H8V5ZM18 19H6V9H18V19ZM11 11H7V13H11V11ZM7 15H11V17H7V15ZM17 11H13V13H17V11ZM13 15H17V17H13V15Z"
                fill=""
              />
            </svg>
